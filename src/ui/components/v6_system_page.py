...
V10_MODULES = [
    {
        ...
        "color": "#A78BFA",
        "modules": [
            {"name": "EpisodicMemory", "import": "src.memory.episodic", "desc": "Mémoire épisodique — souvenirs datés et contextuels"},
            {"name": "SemanticMemory", "import": "src.memory.semantic", "desc": "Mémoire sémantique — connaissances structurées"},
            {"name": "UserMemory", "import": "src.memory.user", "desc": "Mémoire utilisateur — préférences et profile"},
            {"name": "ErrorMemory", "import": "src.memory.errors", "desc": "Mémoire d'erreurs — patterns d'échec et correctifs"},
    ...
    },
    {
        ...
        "modules": [
            ...
            {"name": "ErrorRecovery", "import": "src.agent.recovery", "desc": "Récupération — retry et fallback intelligent"},
    ...
    },
    {
        ...
        "color": "#FF00FF",
        "modules": [
            {"name": "FeedbackCollector", "import": "src.learning.feedback", "desc": "Collecte — feedback utilisateur et auto-évaluation"},
            {"name": "PerformanceTracker", "import": "src.learning.tracker", "desc": "Suivi perf — métriques de qualité temps réel"},
            {"name": "StrategyOptimizer", "import": "src.learning.optimizer", "desc": "Optimisation — ajustement dynamique des stratégies"},
            {"name": "SelfEvaluator", "import": "src.learning.self_eval", "desc": "Auto-évaluation — scoring de la réponse"},
        ],
    },
    {
        ...
        "modules": [
            ...
            {"name": "FeedbackBar", "import": "src.ui.components.feedback_bar", "desc": "Barre feedback — score et tendance"},
