...
async def test_reranker_seuil_integration():
    ...
    # 3. Simuler le reranker (retourne un score élevé) — AsyncMock pour compatibilité await
    ...
    engine.reranker.rerank = AsyncMock(return_value=[])  # Reranker ne trouve rien
    ...
    engine.reranker.rerank = AsyncMock(return_value=[])  # Reranker retourne vide (modèle non chargé)
